...
const AboutFront: React.FunctionComponent = () => {
    ...
    return (
        <PageContainer>
            ...
            <ButtonStripe>
                <LegendButton
                    onPress={() => navigation.navigate('AboutLegend')}
                />
                <AboutButton
                    onPress={() => navigation.navigate('AboutBack')}
                />
            </ButtonStripe>
            <SectionList
                ...
                sections={[
                    {
                        title: i18next.t('about.front.might.title'),
                        color: 'forestgreen',
                        data: [
                            {
                                key: i18next.t(
                    ...
                    {
                        title: i18next.t('about.front.not.title'),
                        color: 'crimson',
                        data: [
                            {
                                key: i18next.t('about.front.not.key1'),
                                uri: 'https://www.eff.org/issues/privacy',
                            },
                            {
                                key: i18next.t('about.front.not.key2'),
                                uri: 'https://www.eff.org/issues/privacy',
                            },
                            {
                                key: i18next.t('about.front.not.key3'),
                                uri: 'https://en.wikipedia.org/wiki/Phoning_home',
                            },
                            {
                                key: i18next.t('about.front.not.key4'),
                                uri: 'https://en.wikipedia.org/wiki/Google_Play_Services#Concerns',
                            },
                            {
                                key: i18next.t('about.front.not.key5'),
                                uri: 'https://www.eff.org/issues/privacy',
                            },
                            {
                                key: i18next.t('about.front.not.key6'),
                                uri: 'https://www.eff.org/issues/privacy',
                            },
                        ],
                    },
